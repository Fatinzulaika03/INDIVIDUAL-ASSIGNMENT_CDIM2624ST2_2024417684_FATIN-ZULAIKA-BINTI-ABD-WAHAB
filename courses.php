...
<head>
    ...
    <title>StudentPortal - Courses</title>
...
<body>
    ...
    <div class="container my-5">
        <div class="text-center mb-5 welcome-section">
            <h2 class="fw-light">Academic <span class="fw-bold">Courses</span></h2>
            <h4 class="text-purple-name">Semester 4 List</h4>
        </div>
        ...
        <div class="table-container shadow-sm">
            <div class="table-responsive">
                <table class="table table-hover table-bordered align-middle mb-0">
                    ...
                    <tbody>
                        <tr>
                            <td class="fw-bold">IMS564</td>
                            <td>USER EXPERIENCE DESIGN</td>
                            <td class="text-center">3.0</td>
                        </tr>
                        <tr>
                            <td class="fw-bold">IMS565</td>
                            <td>INFORMATION SYSTEM PROJECT MANAGEMENT</td>
                            <td class="text-center">3.0</td>
                        </tr>
                        <tr>
                            <td class="fw-bold">IMS566</td>
                            <td>ADVANCED WEB DESIGN DEVELOPMENT AND CONTENT MANAGEMENT</td>
                            <td class="text-center">4.0</td>
                        </tr>
                        <tr>
                            <td class="fw-bold">LCC501</td>
                            <td>ENGLISH FOR PROFESSIONAL CORRESPONDENCE</td>
                            <td class="text-center">2.0</td>
                        </tr>
                        <tr>
                            <td class="fw-bold">TMC501</td>
                            <td>INTRODUCTORY MANDARIN (LEVEL III)</td>
                            <td class="text-center">2.0</td>
                        </tr>
                    </tbody>
                </table>
    ...
    <script>
        ...
        // Theme handling - Persistence across pages
        ...
        function updateIcon(theme) {
            if (theme === 'dark') {
                darkModeIcon.className = 'fa-solid fa-lightbulb';
            } else {
                darkModeIcon.className = 'fa-regular fa-lightbulb';
            }
        }
